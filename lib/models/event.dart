...
class Event {
  ...
  @JsonKey(
    toJson:
        _colorToJson, // Diese Funktion wird aufgerufen, um das 'Color'-Objekt in ein JSON-Format (hier: int) umzuwandeln.
    fromJson:
        _colorFromJson, // Diese Funktion wird aufgerufen, um einen Wert aus JSON zurück in ein 'Color'-Objekt zu konvertieren.
  )
  final Color color;
  ...
  Event({
    ...
    // KORREKTUR: Die Standardfarbe wird auf die erste Farbe
    // aus der vordefinierten Palette gesetzt (AppColors.orange).
